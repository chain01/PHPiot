...
class Autoloader
{
    ...
    public static function loadByNamespace($name)
    {
        ...
        // 如果是PHPiot命名空间，则在当前目录寻找类文件
        if(strpos($name, 'PHPiot\\') === 0)
        {
            $class_file = __DIR__.substr($class_path, strlen('PHPiot')).'.php';
        }
        else 
        {
            // 先尝试在应用目录寻找文件
...
// 设置类自动加载回调函数
spl_autoload_register('\PHPiot\Autoloader::loadByNamespace');